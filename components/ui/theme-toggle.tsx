...
export function ThemeToggle({ userSelectedEffect = "multicolor", onChange }: ThemeToggleProps) {
    ...
    return (
      <div className="block gap-2 mx-auto">
        ...
        <div className="flex items-center justify-center mt-3">
          <button
            className={activeTheme === "dark" ? `flex items-center justify-center border-2 border-white bg-white/20 p-3 rounded-lg hover:cursor-pointer transition-colors` : `flex items-center justify-center border-2 border-black bg-black/40 p-3 rounded-lg hover:cursor-pointer transition-colors`}
            aria-label="Theme Toggle"
            onClick={() => handleThemeToggleClick()}
          >
            {activeTheme === "dark" ? (
              <SunIcon size={64} color="#FFFFFF" userSelectedEffect={userSelectedEffect} />
            ) : (
              <MoonIcon size={64} color="#000000" userSelectedEffect={userSelectedEffect} />
            )}
          </button>
        </div>
      </div>
...
const MoonIcon = ({
  ...
  return (
    <div
      className={`flex items-center justify-center transition-all ${isMulticolor ? "animate-pulse" : ""} ${className}`}
      style={{
        ...(!isMulticolor ? { filter: "grayscale(1)" } : {}),
        ...style
      }}
    >
  ...
  return (
    ...
    >
      <svg width={size + `px`} height={size + `px`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" />
        <g id="SVGRepo_iconCarrier">
          <path d="M8 22H16" stroke={color} opacity="0.25" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M5 19H19" stroke={color} opacity="0.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M2 16H22" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M12 6C8.68629 6 6 8.68629 6 12C6 13.5217 6.56645 14.911 7.5 15.9687H16.5C17.4335 14.911 18 13.5217 18 12C18 8.68629 15.3137 6 12 6Z" stroke={color} strokeWidth="1.5" />
