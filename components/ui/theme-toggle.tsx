...
// }
    return(
        ...
        <button
        className={theme === "dark" ? `flex items-center justify-center border-2 border-white bg-white/20 p-3 rounded-lg hover:cursor-pointer` : `flex items-center justify-center border-2 border-black bg-black/40 p-3 rounded-lg hover:cursor-pointer`}
        aria-label="Theme Toggle"
        onClick={() => handleThemeToggleClick()}
      >
        {theme === "dark" ? (
          <SunIcon size={64} color="#FFFFFF" />
        ) : (
          <MoonIcon size={64} color="#000000" />
        )}
      </button>
      </div>
      </div>
...
const SunIcon = ({size=18, color="FFFFFF", className=""}: {size?: number, color: string, className?: string}) => {
    return (
        <div className={`flex items-center justify-center` + className}>
            ...
            <g id="SVGRepo_iconCarrier"> <path d="M8 22H16" stroke={color}  opacity="0.25" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> <path d="M5 19H19" stroke={color} opacity="0.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> <path d="M2 16H22" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> <path d="M12 6C8.68629 6 6 8.68629 6 12C6 13.5217 6.56645 14.911 7.5 15.9687H16.5C17.4335 14.911 18 13.5217 18 12C18 8.68629 15.3137 6 12 6Z" stroke={color} strokeWidth="1.5"/> <path d="M12 2V3" stroke={color} strokeWidth="1.5" strokeLinecap="round"/> <path d="M22 12L21 12" stroke={color} strokeWidth="1.5" strokeLinecap="round"/> <path d="M3 12L2 12" stroke={color} strokeWidth="1.5" strokeLinecap="round"/> <path d="M19.0708 4.92969L18.678 5.32252" stroke={color} strokeWidth="1.5" strokeLinecap="round"/> <path d="M5.32178 5.32227L4.92894 4.92943" stroke={color} strokeWidth="1.5" strokeLinecap="round"/> </g>
